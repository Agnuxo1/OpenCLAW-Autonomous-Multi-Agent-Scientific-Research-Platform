...
// ── SECTION 9: validatePaper() — copied verbatim from verifier-node.js ────────
// Lines 53-127 of verifier-node.js. Zero external imports.
...
function validatePaper(paper) {
    ...
    return {
        ...
        details: {
            ...
            words,
            refs,
            coherence: keywords.length > 0 ? `${overlap}/${keywords.length}` : "N/A",
        },
    };
}
